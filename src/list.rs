...
impl<T: Component + TableItem + Default + std::fmt::Debug + std::fmt::Debug + std::fmt::Debug> Init<Msg<T>> for Model<T>
{
...
impl <T: Component + preview::Preview + TableItem + std::fmt::Debug + std::fmt::Debug> Viewable for Model<T> {
